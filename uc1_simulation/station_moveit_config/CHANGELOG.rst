^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package station_moveit_config
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* remove old station_moveit_config
...
* Removed ur5_joint_limited_moveit_config.  station_moveit_config now has limited joint ranges to plus/minus 180 degrees.
